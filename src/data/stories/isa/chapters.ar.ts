...
const chapters: StoryChapter[] = [
  {
    id: 'isa-ch1',
    title: 'البشارة لمريم',
    summary: 'اصطفى الله مريم على نساء العالمين وبشّرها بولد كريم هو المسيح عيسى عليه السلام.',
    order: 1,
    paragraphs: [
      {
        id: 'isa-ch1-p1',
        text: 'اصطفى الله مريم وطهّرها واصطفاها على نساء العالمين. بشّرتها الملائكة بولد اسمه المسيح عيسى ابن مريم، وجيهاً في الدنيا والآخرة ومن المقربين عند الله.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch1-p2',
        text: 'سألت مريم كيف يكون لها ولد ولم يمسسها بشر. قال الله: "كذلك الله يخلق ما يشاء. إذا قضى أمراً فإنما يقول له كن فيكون."',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  {
    id: 'isa-ch2',
    title: 'الميلاد المعجز',
    summary: 'انتبذت مريم مكاناً قصياً فولدت عيسى، وتكلّم الطفل في المهد.',
    order: 2,
    paragraphs: [
      {
        id: 'isa-ch2-p1',
        text: 'انتبذت مريم مكاناً قصياً. فأجاءها المخاض إلى جذع النخلة. فنوديت أن تهزّ جذع النخلة لتساقط عليها رطباً جنياً، وأن تشرب من الجدول الذي أجراه الله تحتها.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch2-p2',
        text: 'لما أتت مريم قومها بالطفل اتهموها. لكن الطفل عيسى تكلّم في المهد قائلاً: "إني عبد الله آتاني الكتاب وجعلني نبياً. وجعلني مباركاً أينما كنت."',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  },
  {
    id: 'isa-ch3',
    title: 'معجزات عيسى',
    summary: 'أيّد الله عيسى بمعجزات عظيمة — إحياء الطير من الطين وإبراء الأكمه والأبرص وإحياء الموتى — كل ذلك بإذن الله.',
    order: 3,
    paragraphs: [
      {
        id: 'isa-ch3-p1',
        text: 'أيّد الله عيسى بالمعجزات: كان يخلق من الطين كهيئة الطير فينفخ فيه فيكون طيراً بإذن الله. ويبرئ الأكمه والأبرص ويحيي الموتى بإذن الله. أُعطيت هذه الآيات لبني إسرائيل ليؤمنوا.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch3-p2',
        text: 'قال عيسى لبني إسرائيل: "إنّ الله ربي وربكم فاعبدوه. هذا صراط مستقيم." دعاهم إلى التوحيد الخالص وطاعة الله وحده.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  {
    id: 'isa-ch4',
    title: 'المائدة السماوية',
    summary: 'طلب الحواريون من عيسى أن يسأل ربه إنزال مائدة من السماء، فأنزلها الله آيةً وتحذيراً.',
    order: 4,
    paragraphs: [
      {
        id: 'isa-ch4-p1',
        text: 'طلب حواريّو عيسى منه أن يدعو ربه لينزّل عليهم مائدة من السماء. فدعا عيسى ربه، فأنزل الله عليهم مائدة من السماء آيةً ورزقاً لهم.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch4-p2',
        text: 'حذّر الله أن من كفر بعد هذه الآية البيّنة فسيعذّبه عذاباً لا يعذّبه أحداً من العالمين. كان ذلك اختباراً حاسماً للحواريين.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  },
  {
    id: 'isa-ch5',
    title: 'رفع عيسى',
    summary: 'أنقذ الله عيسى من المتآمرين برفعه إليه، وسيعود قبل يوم القيامة.',
    order: 5,
    paragraphs: [
      {
        id: 'isa-ch5-p1',
        text: 'لما تآمر الكافرون على قتل عيسى، رفعه الله إليه. يقول القرآن بوضوح: "وما قتلوه وما صلبوه ولكن شُبّه لهم." والله عزيز حكيم.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch5-p2',
        text: 'سيعود عيسى قبل يوم القيامة. وهو علم للساعة. وسيؤمن به جميع أهل الكتاب قبل موته، ويوم القيامة يكون عليهم شهيداً.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
