...
const chapters: StoryChapter[] = [
  {
    ...
    summary: 'Allah chose Maryam above the women of the worlds and gave her the glad tidings of a noble son, Al-Masih Isa.',
    order: 1,
    paragraphs: [
      {
        id: 'isa-ch1-p1',
        text: 'Allah chose Maryam (Mary) and purified her above the women of the worlds. Angels told her the good news of a son named Al-Masih, Isa (Jesus), honoured in this world and the Hereafter, and among those brought near to Allah.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch1-p2',
        text: 'Maryam asked how she could have a son when no man had touched her. Allah said: "Thus does Allah create what He wills. When He decrees a matter, He only says \'Be,\' and it is."',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  },
  {
    ...
    summary: 'Maryam withdrew to a remote place where she gave birth to Isa, and the infant spoke from the cradle.',
    order: 2,
    paragraphs: [
      {
        id: 'isa-ch2-p1',
        text: 'Maryam withdrew to a remote place. The pains of childbirth drove her to the trunk of a palm tree. She was told to shake the tree for fresh dates and to drink from a stream that Allah caused to flow beneath her.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch2-p2',
        text: 'When Maryam brought the baby to her people, they accused her. But the infant Isa spoke from the cradle: "Indeed, I am the servant of Allah. He has given me the Scripture and made me a prophet. And He has made me blessed wherever I am."',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  {
    id: 'isa-ch3',
    title: 'The Miracles of Isa',
    summary: 'Allah granted Isa extraordinary miracles including healing the sick, giving life to clay birds, and raising the dead — all by Allah\'s permission.',
    order: 3,
    paragraphs: [
      {
        id: 'isa-ch3-p1',
        text: 'Allah supported Isa with miracles: he fashioned a bird from clay and breathed into it, and it became a living bird by Allah\'s permission. He healed the blind and the leper, and brought the dead to life by Allah\'s permission. These signs were given so that the Children of Israel would believe.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch3-p2',
        text: 'Isa told the Children of Israel: "Indeed, Allah is my Lord and your Lord, so worship Him. That is a straight path." He called them to pure monotheism and obedience to Allah alone.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  },
  {
    ...
    summary: 'The disciples asked Isa to request a table spread from heaven, and Allah sent it down as a sign and a warning.',
    order: 4,
    paragraphs: [
      {
        id: 'isa-ch4-p1',
        text: 'The disciples of Isa asked him to request a table spread from heaven. Isa prayed to Allah, and a table spread was sent down as a sign and provision from Allah for them.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch4-p2',
        text: 'Allah warned that whoever disbelieved after that clear sign would be punished with a punishment not given to anyone else among the worlds. This was a decisive test for the disciples.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
  ...
  {
    id: 'isa-ch5',
    title: 'Ascension of Isa',
    summary: 'Allah saved Isa from the plotters by raising him up, and he will return before the Day of Judgment.',
    order: 5,
    paragraphs: [
      {
        id: 'isa-ch5-p1',
        text: 'When the disbelievers plotted to kill Isa, Allah raised him up to Himself. The Quran states clearly: "They did not kill him, nor did they crucify him; but it was made to appear so to them." Allah is Exalted in Might and Wise.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
      ...
      {
        id: 'isa-ch5-p2',
        text: 'Isa will return before the Day of Judgment. He is a sign of the Hour. All the People of the Book will believe in him before his death, and on the Day of Resurrection he will be a witness over them.',
        phase: 'quran',
        references: [
          {
            type: 'quran',
