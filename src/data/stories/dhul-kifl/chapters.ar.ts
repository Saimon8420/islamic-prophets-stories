...
const chapters: StoryChapter[] = [
  {
    id: 'dhul-kifl-ch1',
    title: 'النبي الصابر',
    summary: 'ذو الكفل مذكور في القرآن بصبره وصلاحه بين الأنبياء.',
    order: 1,
    paragraphs: [
      {
        id: 'dhul-kifl-ch1-p1',
        text: 'ذُكر ذو الكفل مرتين في القرآن الكريم مع أنبياء صالحين آخرين. وقد أُثني عليه لصبره وصلاحه. ذكره الله تعالى مع إسماعيل وإدريس وقال إنهم جميعاً كانوا من الصابرين، وأدخلهم في رحمته لأنهم كانوا من الصالحين.',
        phase: 'quran',
        references: [{
          type: 'quran',
          surah: 21,
      ...
      {
        id: 'dhul-kifl-ch1-p2',
        text: 'كما ذُكر مع إسماعيل وإلياس باعتباره من خيرة الخلق. يذكّر الله المؤمنين بهؤلاء الأنبياء الذين كان كل واحد منهم من الأخيار، ويأمر باتباع نموذجهم في الصبر والإخلاص.',
        phase: 'quran',
        references: [{
          type: 'quran',
          surah: 38,
